...
def main(file_name, recompute_flag=True):
    ...
    if recompute_flag:
        ...
        while success:
            ...
            coords3d = math_transformation.normalize_body(coords3d, math_transformation.unity_body_length, coords2d['ass'], img_shape) # нормализация размера модели по координатам картинки
